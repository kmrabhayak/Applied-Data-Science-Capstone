...
def get_scatter_chart(entered_site, payload_range):
    ...
    if entered_site == 'ALL':
        ...
        fig = px.scatter(filtered_df,
                        ...
                        title=f'All sites - payload mass between {int(payload_range[0])}kg and {int(payload_range[1])}kg')
    else:
        ...
        fig = px.scatter(filtered_df,
                        ...
                        y='class',
                        color='Booster Version Category',
                         title=f'Site {entered_site} - payload mass between {int(payload_range[0])}kg and {int(payload_range[1])}kg')
    return fig
